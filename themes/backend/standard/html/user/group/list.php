<form action="<?php echo Router::buildLink("user", array("view"=>"group")); ?>" method="post" name="adminForm" >
    <div class="row">
        <div class="panel">            
                    ...
                    <tbody>
                        ...
                        if (isset($items) && $items) {
                            foreach ($items as $i => $item) {
                                $link_edit = Router::buildLink("user", array("view"=>"group",'layout'=>'edit', "cid" => $item['id']));                                
                                $item['name'] = str_repeat("&nbsp; &nbsp; ", $item['level']) . " - " . $item['name'];
                                $link_items = Router::buildLink('user', array("view"=>"user", 'layout'=>'tree','groupID'=>$item['id'])); 
