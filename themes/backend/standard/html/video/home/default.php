    ...
    <table class="adminlist" cellpadding="1">
        ...
        <tbody>
            ...
            foreach ($items as $i => $item) {
                $link_edit = Router::buildLink("video",array('layout'=>'edit','cid'=>$item['id']));
                ...
                $link_view = "/goto.php?control=video&action=detail&params=$params";
                $link_created = Router::buildLink("video",array('filter_created_by'=>$item['created_by']));   
                ?>
                <tr class="row1">
                    <td><?php echo ($i + 1); ?></td>
