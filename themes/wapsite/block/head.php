...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo getSysConfig("sys.template.url"); ?>/assets/css/style.css" /> 
        
        <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script>
        <script type="text/javascript" src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>

        <script type="text/javascript" src="<?php echo getSysConfig("sys.template.url"); ?>/assets/js/jscript.js"></script>
        <script type="text/javascript" src="<?php echo getSysConfig("sys.template.url"); ?>/assets/js/jscookies.js"></script>
        ...
        <div class="wrapper <?php echo $pageClassSuffix; ?>" >
            ...
            <div class="header">
                <div class="header-inner">
                    <div class="left" style="cursor: pointer;" onclick="location.href='<?php echo WEB_URL; ?>';" title="<?php echo CHtml::encode($this->pageTitle); ?>">
            ...
            <div class="nav-container">
                <div id="nav"><?php echo fnShowMenu("mainmenu"); ?></div>
            </div>
