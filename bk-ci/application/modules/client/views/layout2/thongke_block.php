<br/>
<div class="thongke_block box-result" style="border:2px solid #e1e1e1;border-bottom-width:1px;border-top:none;background:#f7f7f7">
    <div class="title-tk">BẢNG THỐNG KÊ XỔ SỐ</div>
    <table>
        <tr>
            <td>
                <div style="margin-right:5px">
                <div class="title title-yelow"><div class="title-right"><span class="icon">THỐNG KÊ XỔ SỐ</span></div></div>
                <ul class="category-provide" style="margin:0">
            ...
            <td valign="top">
                ...
                <table>
                    <tr>
                        <td>
                            <ul class="category-provide" style="margin:0 5px 0 0">
