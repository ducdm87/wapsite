...
class HomeController extends BackEndController {
    ...
    public function actionDisplay() { 
        ...
        $this->addIconToolbar("Creat", Router::buildLink("module", array("layout"=>"edit")), "new");
        $this->addIconToolbar("Edit", Router::buildLink("module", array("layout"=>"edit")), "edit", 1, 1, "Please select a item from the list to edit");        
        $this->addIconToolbar("Publish", Router::buildLink("module", array("layout"=>"publish")), "publish");
        $this->addIconToolbar("Unpublish", Router::buildLink("module", array("layout"=>"unpublish")), "unpublish");
        $this->addIconToolbar("Delete", Router::buildLink("module", array("layout"=>"remove")), "trash", 1, 1, "Please select a item from the list to Remove");        
    ...
    public function actionEdit() {global $mainframe, $user;        
        ...
        $this->addIconToolbar("Save", Router::buildLink("module", array("layout"=>"save")), "save");
        $this->addIconToolbar("Apply", Router::buildLink("module", array("layout"=>"apply")), "apply");
        $this->addBarTitle("Module <small>[Edit]</small>", "user");
        $this->addIconToolbar("Close", Router::buildLink("module", array("layout"=>"cancel")), "cancel");
    ...
    function actionApply() {
        $cid = $this->store();
        $this->redirect(Router::buildLink("module", array("layout"=>"edit",'cid'=>$cid)));
    }
    
    function actionSave() {
        $cid = $this->store();
        $this->redirect(Router::buildLink("module"));
    }
