...
class MenuitemController extends BackEndController {
    ...
    public function actionDisplay() {
        ...
        $this->addIconToolbar("Creat", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'new')), "new");
        $this->addIconToolbar("Edit", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'edit')), "edit", 1, 1, "Please select a item from the list to edit");        
        $this->addIconToolbar("Publish", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'publish')), "publish");
        $this->addIconToolbar("Unpublish", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'unpublish')), "unpublish");
        $this->addIconToolbar("Delete", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'remove')), "trash", 1, 1, "Please select a item from the list to Remove");        
    ...
    public function actionEdit() {
        ...
        $this->addIconToolbar("Save", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'save')), "save");
        $this->addIconToolbar("Apply", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'apply')), "apply");
        $items = array();
        ...
        if ($cid == 0) {
            ...
            $this->addIconToolbar("Cancel", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'cancel')), "cancel");        
        }else{
            $this->addBarTitle("Menu item <small>[Edit]</small>", "user");        
            $this->pageTitle = "Edit menu item";
            $this->addIconToolbar("Close", Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'cancel')), "cancel");
        }
    ...
    function actionApply() {
        ...
        if($result == false){
            ...
            $this->redirect(Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID, 'layout'=>'edit','cid'=>$menuItemID)));
        }
    }
    ...
    function actionSave() {
        ...
        if($result == false){
            ...
            list($menuID, $menuItemID) = $result;
            YiiMessage::raseSuccess("Successfully save Menu Item");
            $this->redirect(Router::buildLink("menu", array("view"=>"menuitem",'menu'=>$menuID)));
        }
    }
