...
class HomeController extends BackEndController {
    ...
    public function actionDisplay() {
        ...
        $this->addIconToolbar("New", Router::buildLink("video",array('layout'=>'new')), "new");
        $this->addIconToolbar("Edit", Router::buildLink("video",array('layout'=>'edit')), "edit", 1, 1, "Please select a item from the list to edit");        
        $this->addIconToolbar("Publish", Router::buildLink("video",array('layout'=>'publish')), "publish");
        $this->addIconToolbar("Unpublish", Router::buildLink("video",array('layout'=>'unpublish')), "unpublish");
        $this->addIconToolbar("Delete", Router::buildLink("video",array('layout'=>'remove')), "trash", 1, 1, "Please select a item from the list to Remove");        
    ...
    public function actionEdit() {
        ...
        $this->addIconToolbar("Save", Router::buildLink("video",array('layout'=>'save')), "save");
        $this->addIconToolbar("Apply", Router::buildLink("video",array('layout'=>'apply')), "apply");
        $this->addBarTitle("Video <small>[Edit]</small>", "user");
        $this->addIconToolbar("Close", Router::buildLink("video",array('layout'=>'cancel')), "cancel");
    ...
    function actionApply() {
        ...
        $this->redirect(Router::buildLink("video",array('layout'=>'edit','cid'=>$cid)));
    }
    
    function actionSave() {
        $cid = $this->store();
         YiiMessage::raseSuccess("User save succesfully");
        $this->redirect(Router::buildLink("video"));
    }
